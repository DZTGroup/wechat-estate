    ...
    <div class="box-table"><!-- 添加hide隐藏 -->
        ...
        <div class="box-table"><!-- 添加hide隐藏 -->
            <table width="760" border="0" cellspacing="1" cellpadding="0" bgcolor="#d7d7d7" id="J_entity_table">
                <thead><tr> <th>认筹ID</th> <th>认筹名称</th> <th>楼盘名称</th> <th>认筹岂止时间</th> <th>提交时间</th> <th>状态</th> <th>操作</th></tr></thead>
                <tbody></tbody>
            </table>
        </div>
    </div>
    <div id="J_entity_form" style="display: none;" data-type="reserversion">
        <div class="com-min J_module" data-module="event">
            ...
            <div class="tipe-lb">
                ...
                <input class="inp-tex inp-300" name="" type="text">
            </div>
            <div class="tipe-lb"><label><span class="red">*</span>认筹开始时间：</label>
            <span class="calendar-ctrl"><input type="text" maxlength="10" value="年-月-日" name="" class="text-tips"><span
            ...
            <div class="tipe-lb"><label>详情：</label> <textarea class="text-kuang" name="" cols=""
                                                              rows="">输入350个字以内</textarea></div>
            <div class="tipe-lb"><label><span class="red">*</span>认筹须知：</label> <textarea class="text-kuang" name=""
                                                                                          cols=""
                                                                                          rows="">输入350个字以内</textarea>
            </div>
            <div class="tipe-lb"><label><span class="red">*</span>用户引导提示：</label> <textarea class="text-kuang" name=""
                                                                                            cols=""
                                                                                            rows="">输入50个字以内</textarea>
            </div>
        </div>
        <div class="com-min">
            <h3>认筹设置</h3>
        ...
        <div class="cent-bott">
            <button class="btn-cha" type="button">提交审核</button>
            <button class="btn-cha" type="button">保存草稿</button>
        </div>
    </div>
</div>