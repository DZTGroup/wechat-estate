<div class="cent-auto">
    ...
    <div class="com-min J_module" data-module="intro_info">
        ...
        <div class="tipe-lb">
            <label>正文：</label>
            <textarea class="text-kuang J_field" name="intro_text" cols="" rows="" placeholder="500字以内"></textarea>
        </div>
    </div>
    <div class="com-min J_module" data-module="location_info">
        ...
        <div class="tipe-lb"><label>地址：</label> <input class="inp-tex inp-300 J_field" name="address" type="text"> &lt;定位&gt;</div>
    </div>
    <div class="com-min">
        <h3>户型介绍</h3>
