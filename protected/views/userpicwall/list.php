...
<head>
    ...
    <meta name="description" content="楼盘实景-微生活" />
...
<div class="wrapper">
    <div class="point_nav" id="pointNav">
        <p>在微信对话框内发送 <span class="mark">照片</span> + <span class="mark">你的位置</span></p>
        <p>即可将你拍摄的实景分享给<span id="houseName"></span>房友</p>
    </div>
